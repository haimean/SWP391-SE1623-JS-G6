    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<%= request.getContextPath()%>/storeProductList">Shop</a>
                </li>
                <li class="nav-item">
                ...
                <ul class="nav nav-pills ml-2 " style="margin-left: 1rem;">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="<%= request.getContextPath()%>/userBlogList">MyBlog</a></li>    
