...
<form action="create" method="POST">
    <div class="side-nav-categories">
        <c:forEach items="${requestScope.createCategory}" var="createC">
            ...
            <!--<button type="button" class="btn btn-info" href="update?id=${u.id}" style="font-family: serif;color: #fff;">Create</button>-->
            <button type="button" class="btn btn-primary"style="font-family: serif;color: #fff;">Create</button>
        </c:forEach>
