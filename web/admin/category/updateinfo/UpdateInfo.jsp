<%-- Document : UpdateInfo Created on : Sep 30, 2022, 3:01:00 AM Author : Mr Tuan --%>
						...
						<form action="category_update" method="POST">
							<c:forEach items="${requestScope.updateinfo}" var="u">
								...
								<div class="div-name">
									...
									<input class="text-name" type="text" placeholder="Name..." value="${u.name}"
										name="namenew">
								</div>
							</c:forEach>
							<input type="submit" class="btn btn-primary" style="font-family: serif;color: #fff;"
								value="Update">
						</form>
					</div>
				</div>