...
<div class="container">
    <form action="create" method="post" class="shadow-sm p-3 mb-5 bg-white rounded p-5 mt-5">
        ...
        <div class="form-group mt-5">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Question" name="question"></textarea>
        </div>
        <div class="form-group mt-5">
            <label class="mb-2">Answer</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Answer" name="answer"></textarea>
        </div>
