...
<body>
  ...
  <div class="container">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="name" readonly="" value="${detail.id}"placeholder="">
    </div>
    <div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="pid" name="CategoryId" value="${detail.categoryID}" placeholder="">
    </div>
    <div class="mb-3">
