<%@page import="Model.*" import="Dal.*" import="java.util.ArrayList" import="java.util.List" %>
	<!DOCTYPE html>
	<meta charset="utf-8">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarScroll">
				<ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" style="height: 13rem; overflow: auto;">
							<% List<Category> categories = new DAOCategory().getAllCategory();
								if(categories != null){
								for(Category c : categories){
								%>
								<li><a class="dropdown-item"
										href="<%= request.getContextPath()%>/product?categoryId=<%=c.getId()%>">
										<%=c.getName()%>
									</a></li>
								<% }} %>
						</ul>
				...
				</form <div style="margin-left: 1rem;">
				<a href="#" style="margin-left: 1rem;">
					<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
						class="bi bi-shop" viewBox="0 0 16 16" style="color: white;">
						<path
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<% User user=(User) request.getSession().getAttribute("user"); if(user==null){ %>
								...
								<% }else{ %>
									...
									<li><a class="dropdown-item"
											href="<%= request.getContextPath()%>/message">Message</a></li>
