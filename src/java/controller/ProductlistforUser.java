 ...
 * @author MrTuan
 */
public class ProductlistforUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProductlistforUser</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProductlistforUser at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //DAO import
        ProductDBContext pdao = new ProductDBContext();
        CategoryDBContext cdao = new CategoryDBContext();
        ...
        try {
            ...
            Logger.getLogger(ProductlistforUser.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        request.getRequestDispatcher("./productlist/productlist_users/productlist.jsp").forward(request, response);
//       response.sendRedirect("./productlist/productlist_users/productlist.jsp");
    }
