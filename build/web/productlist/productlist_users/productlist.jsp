...
<html>
    ...
    <body>
        ...
        <form action="/BlogShop/productlistforUser" method="get" name="frGate" class="mt-5 mb-5">
                                ...
                                <nav class="mt-4" aria-label="Page navigation sample">
                                    <ul class="pagination">
                                        ...
                                        <c:if test="${pageCurrent ==1}">
                                            ...
                                            <c:if test="${pageCurrent !=1}">
                                            <li class="page-item"><a class="page-link" href="/BlogShop/productlistforUser?category=${requestScope.category}&beginp=${beginprice}&endp=${endprice}&page=1&s="/BlogShop/productlistforUserort=${requestScope.sortabc}&search=${requestScope.searchname}"">First</a></li>
                                            </c:if>
                                        ...
                                        <c:forEach var="page" begin="${beginPage}" end="${endPage}">
                                            <c:if test="${pageCurrent == page}">
                                                ...
                                                <c:if test="${pageCurrent != page}">
                                                <li class="page-item"><a class="page-link" href="/BlogShop/productlistforUser?category=${requestScope.category}&beginp=${beginprice}&endp=${endprice}&page=${page}&sort=${requestScope.sortabc}&search=${requestScope.searchname}">${page}</a></li>
                                                </c:if>
                                            </c:forEach>
                                        ...
                                        <c:if test="${pageCurrent ==numberPage}">
                                            ...
                                            <c:if test="${pageCurrent !=numberPage}">
                                            <li class="page-item"><a class="page-link" href="/BlogShop/productlistforUser?category=${requestScope.category}&beginp=${beginprice}&endp=${endprice}&page=${numberPage}&sort=${requestScope.sortabc}&search=${requestScope.searchname}">Last</a></li>
                                            </c:if>
                                    </ul>
                                </nav>
                            </c:if>
