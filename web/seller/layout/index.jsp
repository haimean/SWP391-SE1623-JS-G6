...
>>>>>>> 5eb7bafb9c7c5a7b65dfde68d05a8f19f2921932
	...
	<nav class="navbar bg-warning">
		<div class="container-fluid">
			<div class="d-flex align-items-center">
				...
				<a class="" href="<%= request.getContextPath()%>/seller">
					<h3>Seller</h3>
				</a>
			</div>

			<% User user=(User) request.getSession().getAttribute("user"); if (user==null) {
				response.sendRedirect(request.getContextPath()+"/login"); return; } else { int type=user.getRole();
				switch (type) { case 2: %>
				...
				<% break; case 1: response.sendRedirect(request.getContextPath()+"/admin"); break; case 3:
			...
			<div class=" bg-warning" style="
             ...
             padding-bottom: 2rem">
				...
				<ul class="list-group  list-group-flush  bg-warning">
					<li class="list-group-item  bg-warning"><a href="<%= request.getContextPath()%>/seller">
							<h4>Dashboard</h3>
						</a></li>
					<li class="list-group-item  bg-warning"><a href="<%= request.getContextPath()%>/seller/product">
							<h4>Product</h3>
						</a></li>
					<li class="list-group-item  bg-warning"><a href="<%= request.getContextPath()%>/seller/">
							<h4>Order</h3>
				...
				<a class="btn btn-primary mx-auto" href="#" role="button">Message <span
						class="badge bg-light text-body">2</span></a>
			</div>
		</div>
	</div>