...
<html lang="en">
    ...
    <head>
        ...
        <!-- Styles -->
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/calendar2/pignose.calendar.min.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/chartist/chartist.min.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/font-awesome.min.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/themify-icons.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/owl.carousel.min.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/owl.theme.default.min.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/weather-icons.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/menubar/sidebar.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/bootstrap.min.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/lib/helper.css" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/admin/layout/css/style.css" rel="stylesheet">
    ...
    <body>
        ...
        <!-- jquery vendor -->
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/jquery.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/jquery.nanoscroller.min.js"></script>
        <!-- nano scroller -->
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/menubar/sidebar.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/preloader/pace.min.js"></script>
        <!-- sidebar -->
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/bootstrap.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/scripts.js"></script>
        <!-- bootstrap -->
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/calendar-2/moment.latest.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/calendar-2/pignose.calendar.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/calendar-2/pignose.init.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/weather/jquery.simpleWeather.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/weather/weather-init.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/circle-progress/circle-progress.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/circle-progress/circle-progress-init.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/chartist/chartist.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/sparklinechart/jquery.sparkline.min.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/sparklinechart/sparkline.init.js"></script>
        <script src="<%=request.getContextPath()%>/admin/layout/js/lib/owl-carousel/owl.carousel.min.js"></script>
        <!-- scripit init-->
